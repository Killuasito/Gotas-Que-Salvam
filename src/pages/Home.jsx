  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 py-8 sm:py-0">
      <div className="max-w-3xl text-center my-8 sm:my-0">
        ...
        <Link
          to="/certificate"
          className="inline-flex items-center justify-center gap-2 bg-red-600 text-white px-8 py-4 rounded-lg hover:bg-red-700 transition-all transform hover:scale-105 text-lg font-medium shadow-lg hover:shadow-xl"
        >
          <FiAward className="text-2xl" />
          <span>Gerar Certificado</span>
        </Link>

        <div className="mt-12 sm:mt-16 p-6 sm:p-8 bg-white rounded-2xl shadow-xl border border-red-100">
          <h2 className="text-3xl font-bold text-red-800 mb-8">
            Como funciona?
          </h2>

          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center p-6 rounded-xl hover:bg-red-50 transition-colors">
